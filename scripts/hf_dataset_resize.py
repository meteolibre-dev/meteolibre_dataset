...
# to change
ground_height_image = "../data/ground_height_image.npy"
index_file = "../data/hf_dataset/index.parquet"
...
def generate_data_point(
    ...
    Args:
        ...
        shape_image (tuple): Shape of the image to be generated.
    ...
    x = random.randint(0, shape_image // 2 - 512)
    y = random.randint(0, shape_image // 2 - 512)

    for future in range(nb_future_steps):
        path_file = os.path.join(
            dir_index, str(index_dataframe["radar_file_path"].iloc[index + future])
        )
